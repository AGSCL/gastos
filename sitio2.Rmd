...
if(!require(SentimentAnalysis)){install.packages("tidytext")}
...
<div style="border: 1px solid #ddd; padding: 5px; overflow-y: scroll; height:350px; overflow-x: scroll; width:100%">
```{r itsa2, eval=T, echo=T, fig.height=8, fig.width=8, warning=FALSE, fig.align = "center", message=F, caption="Figura 6. Gasto Mensual"}
#tsData_gastos$trend
...
#    facet_wrap(~author, ncol = 2, scales = "free_y") +
    scale_x_reordered() +
    ggtitle("Gastos detallados más usados")
```
